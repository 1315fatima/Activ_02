# -*- coding: utf-8 -*-
"""
Created on Sat Feb 11 18:41:28 2023

@author: Fatima Matamoros
"""
...
etiq= tk.Label(ventana, text= 'Bienvenidos al convertidor de coordenadas', bg= "pink", justify= 'center', font= 'Helvetica 20')
etiq.grid(row= 0, column= 2, columnspan = 5)
...
def DDlon_DMS():
    #caja_GMSlonS.delete(1.0, tk.END)
...
def GMSlon_DD():
    ...
    #caja_DDlon.insert(tk.END, result6)
